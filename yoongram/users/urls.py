...
urlpatterns = [
    ...
    path("<slug:username>/followers/", view=views.UserFollowerUser.as_view(), name="followers_user"),
    path("<slug:username>/following/", view=views.UserFollowingUser.as_view(), name="following_user"),
