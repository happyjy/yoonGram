...
ROOT_DIR = environ.Path(__file__) - 3  # (yoongram/config/settings/base.py - 3 = yoongram/)
APPS_DIR = ROOT_DIR.path('yoongram')
...
MIGRATION_MODULES = {
    'sites': 'yoongram.contrib.sites.migrations'
}
...
# https://django-allauth.readthedocs.io/en/latest/configuration.html
ACCOUNT_ADAPTER = 'yoongram.users.adapters.AccountAdapter'
# https://django-allauth.readthedocs.io/en/latest/configuration.html
SOCIALACCOUNT_ADAPTER = 'yoongram.users.adapters.SocialAccountAdapter'
